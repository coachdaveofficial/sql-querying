...
SELECT app_name, reviews DESC FROM analytics ORDER BY reviews DESC LIMIT 5;
...
SELECT app_name, price, reviews FROM analytics WHERE price < 1.00 AND price > 0.10 ORDER BY reviews DESC;
...
SELECT SUM(reviews) AS Num_of_Reviews FROM analytics;
